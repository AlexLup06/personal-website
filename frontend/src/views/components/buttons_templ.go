...
func Lg() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<button class=\"px-5 py-3 rounded-2xl active:scale-95 hover:bg-second-25 text-white hover:text-second-500 \n\t\t\t\toutline-2 outline-second-400 transition cursor-pointer\n\t\t\t  bg-second-400 flex items-center gap-2 w-fit text-lg\">")
		if templ_7745c5c3_Err != nil {
